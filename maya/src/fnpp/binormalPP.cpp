...
MTypeId binormalPP::id(k_binormalPP);
MObject binormalPP::aInput1;
MObject binormalPP::aInput2;
MObject binormalPP::aOutput;



void * binormalPP::creator () {
	return new binormalPP;
}

/// Post constructor
void
	binormalPP::postConstructor()
{
...
binormalPP::binormalPP () {}
binormalPP::~binormalPP () {}

MStatus binormalPP::compute(const MPlug& plug, MDataBlock& data) {
