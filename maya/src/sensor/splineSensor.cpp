...
MStatus splineSensor::assess( MDataBlock& data, const splinePoolData * sd , MVectorArray &assessment )
{
	MStatus st;
...
MStatus splineSensor::initialize()
{
	...
	aTangent	= nAttr.create("tangent","tan", MFnNumericData::kDouble, 1.0, &st); er;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	st = addAttribute(aTangent); er;

	aNormal	= nAttr.create("normal","nor", MFnNumericData::kDouble, 0.0, &st); er;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	...
	aOrbital	= nAttr.create("orbital","orb", MFnNumericData::kDouble, 0.0, &st); er;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	st = addAttribute(aOrbital); er;
	
	aTangentFalloff	= nAttr.create("tangentFalloff","tanf", MFnNumericData::kDouble, 1.0, &st); er;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	...
	aNormalFalloff	= nAttr.create("normalFalloff","norf", MFnNumericData::kDouble, 0.0, &st); er;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	...
	aOrbitalFalloff	= nAttr.create("orbitalFalloff","orbf", MFnNumericData::kDouble, 0.0, &st); er;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	...
	aTangentParam	= nAttr.create("tangentParam","tanp", MFnNumericData::kDouble, 1.0, &st); er;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	st = addAttribute(aTangentParam); er;

	aNormalParam	= nAttr.create("normalParam","norp", MFnNumericData::kDouble, 0.0, &st); er;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	st = addAttribute(aNormalParam); er;
	
	aOrbitalParam	= nAttr.create("orbitalParam","orbp", MFnNumericData::kDouble, 0.0, &st); er;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	st = addAttribute(aOrbitalParam); er;
	...
	aSplinePool = tAttr.create("splinePool", "spl", splinePoolData::id ) ; er;
	tAttr.setStorable(false);
	tAttr.setCached(false);
	st = addAttribute( aSplinePool ); er;
