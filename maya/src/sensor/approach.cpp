...
approach::initialize()
{
	...
	aMaxSeparation	= nAttr.create("maxSeparation", "mxs", MFnNumericData::kDouble, 1.0, &st);
	mser;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	st = addAttribute(aMaxSeparation); mser;
	//--------------



	aSeparationDecay	= nAttr.create("separationDecay", "sdc", MFnNumericData::kDouble, 1.0,
	                                 &st); mser;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	st = addAttribute(aSeparationDecay); mser;
	//--------------
	//--------------


	aMaxTime	= nAttr.create("maxTime", "mxt", MFnNumericData::kDouble, 1.0, &st); mser;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	st = addAttribute(aMaxTime); mser;
	//--------------


	aTimeDecay	= nAttr.create("timeDecay", "tdc", MFnNumericData::kDouble, 1.0, &st); mser;
	nAttr.setHidden(false);
	nAttr.setKeyable(true);
	nAttr.setStorable(true);
	nAttr.setWritable(true);
	st = addAttribute(aTimeDecay); mser;
	//--------------
